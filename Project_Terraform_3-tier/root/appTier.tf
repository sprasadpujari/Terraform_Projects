#subnet for app layer private subnet 1a
...
#subnet for app layer private subnet 1b
...
# route table association with private_1a
...
# route table association with private_1b
